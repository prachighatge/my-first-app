  ...
  const handleSearch = () => {
    ...
    switch (section) {
      ...
      case 'books':
        ...
        break;
      case 'weather':
      apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${query}&appid=3c577e18aeb416d1b165b1dfd683655c&units=metric`;
        break;
      default:
        return;
    }
    ...
    fetch(apiUrl)
      ...
      .then(data => {
        if (section === 'github') {
          ...
          setResults(data.docs.slice(0, 10)); // top 10 results
        } else if (section === 'weather') {
          setResults([data.current_condition[0]]);
        }
        setLoading(false);
      });
  };
